...
thephuckinstart:
echo "\n";
userinput("Masukan Target Contoh: www.site.com
...
elseif ($ip == "fix")
  {
    ...
    echo $bold . $fgreen . "[i] Job finished successfully! Please Restart RED  \n";
    exit;
  }
...
elseif (strpos($ip, ' ') !== false)
  ...
  {
    echo "\n";
    userinput("pilihan nomor 1 atau nomor 2
...
┃┃┗┫ ┃┃┃ ┃┃┗┫┣╸ ┗━┓┃┣━┫┃┗┫   ┃  ┗┳┛┣┻┓┣╸ ┣┳┛   ┣━┫┣┳┛┃┃┃┗┳┛
╹╹ ╹╺┻┛┗━┛╹ ╹┗━╸┗━┛╹╹ ╹╹ ╹   ┗━╸ ╹ ┗━┛┗━╸╹┗╸   ╹ ╹╹┗╸╹ ╹ ╹
$green Wabsite Target -> : " . $red . $ipsl . $ip . $red . "
      \n\n";
    echo $green . " [0]  Basic Recon$white $yellow \n [1]  Whois Lookup \n [2]  Geo-IP Lookup \n [3]  Grab Banners \n [4]  DNS Lookup \n [5]  Subnet Calculator \n [6]  NMAP Port Scan \n [7]  Subdomain Scanner \n [8]  Reverse IP Lookup & CMS Detection \n [9]  SQLi Scanner \n [10] Bloggers View \n [11] WordPress Scan \n [12] Crawler \n [13] MX Lookup \n$magenta [A]  Scan For Everything \n$blue [F]  Fix \n$fgreen [U]  Check For Updates \n$white [B]  Scan Another Website \n$red [Q]  Keluar \n\n" . $cln;
askscan:
    userinput("Pilih Yang mana? ");
    ...
    if (!in_array($scan, array(
    ...
    else
      {
        ...
        elseif ($scan == "0")
          {
            ...
            echo "\n\n";
            echo $bold . $yellow . "[*] Scanning Complete. Klik Enter Untuk Melanjutkan Scanning\n\n";
                ...
                if ($wp_version != "")
                  {
                    ...
                    if (strpos($vuln_json, "The page you were looking for doesn't exist (404)") !== false)
                      {
                        echo $red . "[!] Seems like the version detection messed up preety bad! Please report here: https://github.com/Tuhinshubhra/IFC/issues/new\n";
                      }
                    else
                      {
        ...
        elseif ($scan == 'U' || $scan == 'u')
          {
            ...
            if ($latestversion > $rhversion)
              {
                echo $bold . $fgreen . "\n\n[U] Update Available, Please Update Your Version Of ICA \n" . $cln;
                echo $bold . $white . "    Link: https://github.com/21D4N404/ICA\n\n" . $cln;
              }

            elseif ($rhversion == $latestversion)
              {
                echo $bold . $fgreen . "\n[i] You are already running the latest version of ICA. \n\n" . $cln;
              }
            else
              {
        ...
        elseif ($scan == "F" || $scan == "f"){
          ...
          echo $bold . $fgreen . "[i] Job finished successfully! Please Restart ICA  \n";
          exit;
        }
