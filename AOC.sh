...
echo $cyan* [*$white*       Di luar folder jngan di dalam folder
echo $purple"___________________________________________________"
...
echo $cyan"[+] MR.NAGON_T47 "
echo $cyan"[+] KOKO "
echo $cyan"[+] MR.L3RBI "
echo $cyan"[+] MR.W3B_XIT "
echo $cyan"[+] Solo_King3198
echo $red"################# INFO ####################"
echo $indigo"__________________________________________"
echo $cyan"["$yellow"B"$cyan"]"$white"back "$cyan"["$yellow"Q"$cyan"]"$white"Quit"
read -p "[B/Q] " back
...
#IndoCyber copyright
#author By Chemod_zrd4p4
#Team I.C.A {Indonesian Cyber Army}
