...
echo $purple"___________________________________________________"
echo $red"	~"$cyan"{"$white"1"$cyan"}"$white".Deface"$cyan"     {"$white"4"$cyan"}"$white".AdminLogin"$cyan"
echo $red"	~"$cyan"{"$white"2"$cyan"}"$white".Takescript"$cyan" {"$white"I"$cyan"}"$white"Info "
echo $red"	~"$cyan"{"$white"3"$cyan"}"$white".Exploit"$cyan"    {"$white"Q"$cyan"}"$white"Quit "
echo $purple"___________________________________________________"
...
echo $cyan"[+] MR.NAGON_TA7 "
echo $cyan"[+] MR.W3B_XIT "
echo $cyan"[+] MR.L3BRI
echo $cyan"[+] All Member Indonesian Cyber Army "
echo $red"################# INFO ####################"
echo $indigo"__________________________________________"
echo $cyan"["$yellow"B"$cyan"]"$white"back "$cyan"["$yellow"Q"$cyan"]"$white"Quit"
read -p "[B/Q] " back
